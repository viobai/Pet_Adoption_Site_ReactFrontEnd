          ...
          <form onSubmit={onSubmit} className={style.formContainer}>
            ...
            <div className={style.inputContainer}>
              <label className={style.question} htmlFor="phoneId"><span className={style.required}>*</span> Phone:
                <input required type="tel" pattern="[0-9]{10}" placeholder="1234567890" name="phone" id="phoneId"/>
              </label>
            </div>
            ...
            <div className={style.inputContainer}>
              ...
              {showHouseMember && 
                <div className={style.houseMemberList}>
                  ...
                  <p>* No need to select checkboxes if your pet is neither cat nor dog.</p>
                </div>
